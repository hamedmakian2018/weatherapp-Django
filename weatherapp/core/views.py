...
def home(request):
     ...
     context1 = dict()
     context1['longitude'] = result[0]
     context1['latitude'] = result[1]
     context1['state_weather']= result[2]
     context1['des_weather']= result[3]
     context1['temp']= result[4]
     context1['temp_min']= result[5]
     context1['temp_max']= result[6]
     context1['pressure']= result[7]
     context1['humidity']= result[8]
     context1['wind_speed']= result[9]
     context1['clouds']= result[10]
     context1['country']= result[11]
     context1['city_name']= result[12]
     context1['icon']= result[13]
     context1['destotal']= result[14]
